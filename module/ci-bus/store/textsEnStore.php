		...
		public function __construct($data = array())
		{
		    ...
		    $this->parseStore('texts', array(
		        ...
		        'home' => array (
		            ...
		            'tx4' => 'Developing Apps with Extjs for big companies as the bank ING, Volskwagen, Curanum, ICIS +, Lufthansa among others I could estimate cadences and aspects of the framework that me were turning out to be troublesome, the worst of all as Angular it is the absurd and enormous complexity at the moment of making myself simple tasks, I think firmly that the \'minimalist code\' is the correct way, when a framework is more complex coming to the point of giving more work instead of removing it for my it loses the sense, projects exist like jQuery that have could be kept in the simplicity and the flexibility.\nDays after day happened to me small ideas and better manners of making things apply as styles, listeners, of creating elements, of loading information... up to coming to the day in which all that became condensed, it knew that it would use jQuery and I thought in bootstrap for the styles, put on hands to the work and as if it was recreating it gave up several hundreds of lines of codes which were creating elements html on the basis of definitions in objects JavaScript, Ci-bus my second framework was given his first steps of life.',
		            'tx5' => 'What is the objetive?',
		            'tx6' => 'To leave a witness of my capacities as architect of software creating a framework very easy to use, simplicity first of all, versatility and lightness, doing that the programmers enjoy working doing things about which they make you think... this is going to exploit... and that works.',
