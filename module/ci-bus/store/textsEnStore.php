		...
		public function __construct($data = array())
		{
		    ...
		    $this->parseStore('texts', array(
		        ...
		        'home' => array (
		            ...
		            'tx2' => 'Ci-bus is a set of JavaScript and php tools that will allow you to create web applications in an easy and intuitive way with the latest programming techniques',
		            'tx3' => 'What have been my motivations?',
		            'tx4' => 'Developing Apps with Extjs for large companies such as the bank ING, Volskwagen, Curanum, ICIS +, Lufthansa among others I could appreciate cadences and aspects of the framework that were annoying, the worst of all as Angular is the absurd and inordinate complexity at the time to do simple tasks, I firmly believe that the \'minimalist code\' is the right path, I do not have that ... it is very powerful ... when a framework is gaining in complexity reaching the point of giving more work instead to remove it for me loses its meaning, there are projects like jQuery that have managed to maintain their simplicity and flexibility. Days after day I came up with small ideas and better ways to do things like apply styles, listeners, create items, upload data ... until the day when all that condensed, I knew I would use jQuery and I thought of bootstrap for the styles, I got down to work and as if I was recreating it I released several hundred lines of codes which created html elements based on definitions in JavaScript objects, ci-bus my second framework took its first steps of life.',
		            'tx5' => 'What is the objetive?',
		            'tx6' => 'Record my abilities as a software architect creating a very easy to use framework, simplicity first of all, versatility and lightness, make programmers enjoy working doing things that make you think ... this will explode ... and so it works.',
